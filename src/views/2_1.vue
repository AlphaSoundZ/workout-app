...
export default {
  data () {
    return {
      ...
      title: 'Leg Raises an der Klimmzugstange',
      description: 'Muskelgruppe: \n Oberer Teil der geraden Bauchmuskelatur \n \n Zu beachten: \n Schultern/Hintern anspannen, Knie auf Hüfthöhe \n \n Variationen: \n Beine anwinkeln (Knie zur Brust ziehen) \n \n Wiederholungszahl: \n 15-20',
      modelFile: 'hanging-leg-raises.glb',
